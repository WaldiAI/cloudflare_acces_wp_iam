...
This plugin uses the open source [`firebase/php-jwt`](https://github.com/firebase/php-jwt) library to decode and validate Cloudflare Access JWTs.

The library is used for:

- parsing JWT payloads
- loading JWKS public keys
- verifying the Cloudflare Access JWT signature
- handling JWT validation errors such as expired or invalid tokens
